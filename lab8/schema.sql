CREATE TABLE `page_list` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=16402 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci
...
<body onload="loadMenu(); loadBackground(); startclock();">
    ...
    <div class="text-format">
        ...
        <p>
            <span class="highlight">Most <span class="underline">Akashi Kaikyō</span>, znany również jako <span class="italic">Pearl Bridge</span>, łączy miasta <span class="italic">Kobe</span> i <span class="italic">Awaji</span> na wyspie <span class="italic">Awaji.</span></span>
        </p>
        <p>
            <span class="highlight">Jego konstrukcja rozpoczęła się w 1988 roku, a ukończono ją w 1998 roku. Most jest odporny na trzęsienia ziemi i silne wiatry, co czyni go jednym z najbezpieczniejszych mostów na świecie.</span>
        </p>
    </div>
</body>
</html>', 1),
...
<body onload="loadMenu(); loadBackground(); startclock();">
    ...
    <div class="text-format">
        ...
        <p>
            <span class="highlight">Most <span class="underline">Hong Kong-Zhuhai-Macau</span> to najdłuższy most morski na świecie, łączący <span class="italic">Hongkong, Zhuhai i Makau.</span></span>
        </p>
        <p>
            <span class="highlight">Rozciąga się na dystansie 55 kilometrów i jest jednym z największych osiągnięć współczesnej inżynierii w Chinach.</span>
        </p>
    </div>
</body>
</html>', 1),
...
<body onload="loadMenu(); loadBackground(); startclock();">
    ...
    <h1>Most Golden Gate</h1>
    <div class="text-format">
        <img src="img/goldengate.jpg" alt="Most Golden Gate" width="600">
        <p>
            <span class="highlight">Most <span class="underline">Golden Gate</span> to ikoniczny most wiszący w <span class="italic">San Francisco, w Kalifornii.</span></span>
        </p>
        <p>
            <span class="highlight">Rozciąga się nad cieśniną Golden Gate i jest rozpoznawalny na całym świecie dzięki swojemu charakterystycznemu pomarańczowemu kolorowi oraz stylowi <span class="italic">Art Deco.</span></span>
        </p>
    </div>
</body>
</html>', 1),
...
<body onload="loadMenu(); loadBackground(); startclock();">
    ...
    <div class="text-format">
        ...
        <p>
            <span class="highlight">Most <span class="underline">Vasco da Gama</span> w <span class="italic">Lizbonie</span>, otwarty w 1998 roku, ma ponad 17 kilometrów długości, co czyni go jednym z najdłuższych mostów w Europie.</span>      
        </p>
        <p>
            <span class="highlight">Jego imponująca konstrukcja łączy północne i południowe brzegi rzeki <span class="italic">Tag</span>, odciążając ruch w stolicy <span class="italic">Portugalii.</span></span>
        </p>
    </div>
</body>
</html>', 1),
